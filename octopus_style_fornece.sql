...
CREATE TABLE `fornece` (
  `id_fornece` int NOT NULL AUTO_INCREMENT,
  `id_fornecedor` int NOT NULL,
  `id_produto` int NOT NULL,
  PRIMARY KEY (`id_fornece`),
  KEY `id_produto` (`id_produto`),
  KEY `id_fornecedor` (`id_fornecedor`),
  CONSTRAINT `fornece_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`),
...
INSERT INTO `fornece` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5);
